...
help:
	@echo ""
	@echo "Welcome to tc-lib-pdf-page make."
...
docs:
	@rm -rf target/phpdocs && ./vendor/phpdocumentor/phpdocumentor/bin/phpdoc project:run --target="target/phpdocs/" --directory="src/" --ignore="vendor/" --encoding="UTF-8" --title="tc-lib-pdf-page" --parseprivate
